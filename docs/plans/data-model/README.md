...
> **Status: DM1–DM11 complete; DM12/DM13 remain consumer/design gated; DM14 complete.** Design authority:
...
| DM14 | `14-text-symbol-sets.md` | Constraint layer opened with text symbol sets (archive `kind`, JVM enums) | ☑ 2026-09-23 |
