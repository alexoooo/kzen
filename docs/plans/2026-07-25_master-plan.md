...
| **E** | `2026-07-25_extensibility-improvements.md` | Plugin = classloader (process-global `KzenAutoRuntime`), plugin UX, Custom power, plain-object data shape, object-graph paths, closeable streams and items; absorbs reflection R5/R6. **E1 ratified 2026-09-04; reviews 1–3 of the hosting analysis folded in** | E2–E4, E7–E9 |
...
`kzen-sample-plugin` over real market data) is **analysed and reviewed three times** — `docs/analysis/2026-09-03_in-process-hosting.md`;
