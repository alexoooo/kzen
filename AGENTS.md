...
All commands assume the working directory is `C:\Users\ostro\IdeaProjects\kzen` (or any of the included builds — Gradle resolves *artifact substitutions* either way; *task addressing* does NOT — see the gotcha below). The wrapper is Gradle 9.6.0 on Java 25.
...
- Kotlin `2.4.0`, KSP (`com.google.devtools.ksp`) `2.3.9`, Ktor `3.5.0`, JVM toolchain & target `25`
